...
describe('Bank e2e test', () => {
  ...
  it('should load Banks', async () => {
    ...
    expect(await bankComponentsPage.getTitle()).to.eq('mybaamtuappApp.bank.home.title');
  ...
  it('should load create Bank page', async () => {
    ...
    expect(await bankUpdatePage.getPageTitle()).to.eq('mybaamtuappApp.bank.home.createOrEditLabel');
  ...
  it('should create and save Banks', async () => {
    ...
    await promise.all([bankUpdatePage.setNameInput('name'), bankUpdatePage.setAddressInput('address')]);
  ...
  it('should delete last Bank', async () => {
    ...
    expect(await bankDeleteDialog.getDialogTitle()).to.eq('mybaamtuappApp.bank.delete.question');
