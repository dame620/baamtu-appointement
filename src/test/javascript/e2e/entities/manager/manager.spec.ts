...
import { ManagerComponentsPage, ManagerDeleteDialog, ManagerUpdatePage } from './manager.page-object';
...
describe('Manager e2e test', () => {
  ...
  it('should load Managers', async () => {
    ...
    expect(await managerComponentsPage.getTitle()).to.eq('mybaamtuappApp.manager.home.title');
  ...
  it('should load create Manager page', async () => {
    ...
    expect(await managerUpdatePage.getPageTitle()).to.eq('mybaamtuappApp.manager.home.createOrEditLabel');
  ...
  it('should create and save Managers', async () => {
    ...
    await promise.all([
      managerUpdatePage.setRegistrationNumberInput('registrationNumber'),
      managerUpdatePage.setDepartmentInput('department'),
      managerUpdatePage.userSelectLastOption(),
      managerUpdatePage.companySelectLastOption(),
    ]);
  ...
  it('should delete last Manager', async () => {
    ...
    expect(await managerDeleteDialog.getDialogTitle()).to.eq('mybaamtuappApp.manager.delete.question');
