...
class AppointmentResourceIT {
    ...
    public static Appointment createEntity(EntityManager em) {
        Appointment appointment = new Appointment().reason(DEFAULT_REASON).date(DEFAULT_DATE);
        return appointment;
    }
    ...
    public static Appointment createUpdatedEntity(EntityManager em) {
        Appointment appointment = new Appointment().reason(UPDATED_REASON).date(UPDATED_DATE);
        return appointment;
    }
    ...
    void putNewAppointment() throws Exception {
        ...
        updatedAppointment.reason(UPDATED_REASON).date(UPDATED_DATE);
    ...
    void partialUpdateAppointmentWithPatch() throws Exception {
        ...
        partialUpdatedAppointment.reason(UPDATED_REASON).date(UPDATED_DATE);
